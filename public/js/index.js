...
(() => {
    ...
    class Profile extends HDivision{
        constructor(id,firstName, lastName, position, pic,content,educations,experiences,certifications, frame) {
            super(id);
            this.frame=frame;
            this.addCustomStyle([
                Display('none'),
...

            {
                educations.forEach((item,index) =>{
                    this.educationDiv.addComponent(new ProfileItem2(this.id+"educations"+index,item.dateobtained ,item.degree))
                });
                experiences.forEach((item,index)=>{
                    this.experienceDiv.addComponent(new ProfileItem2(this.id+"experiences"+index, item.experience,
    ...
    class Staff extends HDivision{
        constructor(id,src, firstName, lastName, position,content,educations,experiences,certifications,frame) {
            super(id);
            this.addCustomStyle(
                [
                    Width(400,'px'),
            ...
            this.profile = new Profile(this.id+'pf', firstName,lastName,position,src,content,educations,experiences,certifications,frame);
    ...
    class Home extends HDivision{
        ...
        initTopPanels(){
            this.imagebuffer = new HImage('buffer', '/images/b1.png',"null");
        ...
        setUpTitleAreaWS(){
            ...
            this.image = new HImage(this.id+'bgc',"/images/b1.png","");
            this.image.addCustomStyle([
                    Width(100),
                    Position("absolute"),
                    PositionLeft(0,'px')
        ...
        setUpInformationCenterWS(){
            ...
            this.slideShow.addSlide(
                new Slide(1, "/images/banner1.png", this));
            this.slideShow.addSlide(
                new Slide(2, "/images/banner2.png", this));
            this.slideShow.addSlide(
                new Slide(3, "/images/banner1.png", this));
            this.slideShow.addSlide(
                new Slide(4, "/images/banner2.png", this));
        ...
        initServices(){
            ...
            this.dca = new Service("dca","DCA","/images/kW.png","/services/dca");
            this.stockFin = new Service("stockFin","Stock Finance","/images/sf.png","/services/stockfinance");
            this.assetFin = new Service("assetFin","Asset Finance","/images/aF.png","/services/assetfinancing");
            this.projectFinance = new Service("projectFinance","Project Finance","/images/pF.png","/services/projectfinancing");
            this.basiri = new Service("basiri","Basiri","/images/bS.png","/images/services/basiri");
            this.lpoFinance = new Service("lpoFinances","LPO Financing","/images/lpo.png","/services/lpo(localpurchaseorder)financing");
            this.agbajowo = new Service("agabjowo","Agbajowo","/images/aJ.png","/services/agbajowo");
            this.agLoanScheme = new Service("agLoanscheme","Agricultural Loan Scheme","/images/aL.png","/services/agriculturallending");
    ...
    class Services extends HDivision{
        ...
        initCentre(){
            this.overdrafts = new ServiceBN('overdrafts',"OVERDRAFTS","/images/banner1.png","/images/banner2.png",
            ...
            this.dca = new ServiceBN('dca',"DCA","/images/kowope1.jpg","/images/kowope2.jpg","DCA",
            ...
            this.stockFinance = new ServiceBN('stockFinance',"STOCK FINANCE","/images/stockFinance1.jpg","/images/stockFinance2.jpg","Stock Finance",
            ...
            addRPDBCondition("Default charge: Attracts high default charges.");
            this.assetFinance = new ServiceBN('assetF',"ASSET FINANCING","/images/assetFinance1.jpg","/images/assetFinance2.jpg","Asset Finance",
            ...
            addRPDBCondition("Daily/Weekly payment/monthly payment").
            addRPDBCondition("Default charge:  Attracts high default charges.");
            this.projectFinance = new ServiceBN('stock',"PROJECT FINANCING","/images/projectFinance1.jpg","/images/projectFinance2.jpg","Asset Finance",
            ...
            addRPDBCondition("•Default charge:  Attracts high default charges.");
            this.basiri = new ServiceBN('basiri',"BASIRI","/images/basiri1.jpg","/images/basiri2.jpg","Basiri",
            ...
            addRPDBCondition("•Monthly payment/quarterly").
            addRPDBCondition("•Default charge:  Attracts high default charges.");
            this.lpo = new ServiceBN('lpo',"LPO (Local Purchase Order) Financing","/images/lpoFinancing1.jpg","/images/lpoFinancing2.jpg","LPO Financing",
            ...
            addRPDBCondition("•Delinquent : 5.5% on installment").
            addRPDBCondition("•Default charge:  Attracts high default charges.");
            this.agbajowo = new ServiceBN('agbajowo',"AGBAJOWO","/images/agbajowo1.jpg","/images/agbajowo2.jpg","Agbajowo",
            ...
            addRPDBCondition("Daily/Weekly payment/monthly payment/quarterly").
            addRPDBCondition("Default charge:  Attracts high default charges.");
            this.agricLending = new ServiceBN('agricLending',"AGRICULTURAL LENDING","/images/agricLoanScheme1.jpg","/images/agricLoanScheme2.jpg","Others",
    ...
    class AboutUs extends HDivision{
        ...
        initTopPanels(){
            ...
            this.image= new HImage("vmImg","/images/vm.png","Vision and Mission");
            this.cValues = new HImage("cValues","/images/cvalues.png","Core Values");
                        ...
                        if(profile.position === "C.E.O") {
                            this.board.addComponent(
                                new Staff("staff" + profile.id, profile.image, profile.firstName,
                                    profile.lastName, profile.position, profile.content,profile.educations,profile.experiences,profile.certifications, this.frame)
                            );
                        }
                        else{
                            this.board.addComponent(
            ...
            console.log(JSON.parse(localStorage.getItem("profiles"))['profiles'])
            JSON.parse(localStorage.getItem("profiles"))['profiles'].forEach(
                (profile)=>{
                    if(profile.type === "management"){
                        this.team.addComponent(
                            profile.position === "Managing Director"?
                                new Staff("staff"+profile.id, profile.image, profile.firstName, profile.lastName, profile.position,profile.content,profile.educations,profile.experiences,profile.certifications, this.frame).addCustomStyle([
                                    Display('block'),
                                    Width(100,'%'),
                                ]):  new Staff("staff"+profile.id, profile.image, profile.firstName, profile.lastName, profile.position,profile.content,profile.educations,profile.experiences,profile.certifications, this.frame)
                        );
                    }
                }
            );
    ...
    class ResourceCentre extends HDivision{
       ...
       NEWS AND MEDIA
            ...
            //this.newsPanel.addSlide(new NewsSlide(6, "/images/banner1.png", this))
    ...
    class Login extends HDivision{
        constructor(id) {
            ...
            this.image = Division(this.id+"_Idiv").addCustomStyle([
                    ...
                    Width(350,'px'),
                    Height(400,'px'),
                    BackgroundImage("/images/b2.png",true),
                    Display("inline"),
                    Float("left"),
                    Transition()
                ]
    ...
    class MainView extends HDivision{
        ...
        initLogoWS(){
            ...
            this.logoImage= new HImage("image_"+this.id, "/images/logo.jpg","");
